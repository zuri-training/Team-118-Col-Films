...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(help_text='enter video short name', max_length=255, verbose_name='video title')),
                ('description', models.TextField(help_text='long video description', verbose_name='long description')),
                ('cover', models.ImageField(blank=True, help_text='cover image', null=True, upload_to='reels/cover', verbose_name='video cover')),
                ...
                ('date', models.DateTimeField(default=django.utils.timezone.now, help_text='date video was uploaded', verbose_name='date uploaded')),
            ],
            options={
                'ordering': ['-date', 'name'],
            },
