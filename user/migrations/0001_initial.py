    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('college_id', models.ImageField(blank=True, null=True, upload_to='verification', verbose_name='College ID')),
                ('is_verified', models.BooleanField(default=False, help_text='Designates whether user is verified college student.', verbose_name='college student status')),
